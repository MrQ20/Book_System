	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="/book_ManagerSystem/user/findAll">用户管理</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='/book_ManagerSystem/pages/user-add.jsp'">
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="/book_ManagerSystem/users/findById?id=${user.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="/book_ManagerSystem/users/findUserByIdAndAllRole?id=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
