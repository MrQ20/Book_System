	...
	<div class="wrapper">
				...
				<div class="box box-primary">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='/book_ManagerSystem/pages/book-add.jsp'">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc sorting_desc_disabled">出版时间</th>
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="book">
										<tr>
											...
											<td>${book.bookName }</td>
											<td>${book.author }</td>
											<td>${book.publishTimeStr}</td>
											<td>${book.statuStr}</td>
											<td class="text-center">
												<security:authorize access="hasRole('Manager')"><a href="/book_ManagerSystem/books/findById?id=${book.id}" class="btn bg-olive btn-xs">修改</a></security:authorize>
												<a href="/book_ManagerSystem/books/updateStatuById?id=${book.id}" class="btn bg-olive btn-xs">借阅</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="/book_ManagerSystem/books/findAll?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
								</li>
								<li><a href="/book_ManagerSystem/books/findAll?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<li><a href="/book_ManagerSystem/books/findAll?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
								</c:forEach>
								<li><a href="/book_ManagerSystem/books/findAll?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
								<li>
									<a href="/book_ManagerSystem/books/findAll?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
		...
		<script>
			function changePageSize() {
				...
				//向服务器发送请求，改变没页显示条数
				location.href = "/book_ManagerSystem/books/findAll?page=1&size="
						+ pageSize;
			}
