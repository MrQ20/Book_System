...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				个人借阅<small>全部借阅</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="/book_ManagerSystem/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="/book_ManagerSystem/myBookfindAll/findMyBookAll">借阅管理</a></li>

				<li class="active">我的借阅</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
									...
									<c:forEach items="${pageInfo.list}" var="book">
										<tr>
											...
											<td class="text-center">
												<a href="/book_ManagerSystem/books/deleteMyBook?id=${book.id}" class="btn bg-olive btn-xs">归还</a>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a href="/book_ManagerSystem/books/findMyBookAll?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
								</li>
								<li><a href="/book_ManagerSystem/books/findMyBookAll?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
								<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
									<li><a href="/book_ManagerSystem/books/findMyBookAll?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
								</c:forEach>
								<li><a href="/book_ManagerSystem/books/findMyBookAll?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
								<li>
									<a href="/book_ManagerSystem/books/findMyBookAll?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
		...
		<script>
			function changePageSize() {
				...
				//向服务器发送请求，改变没页显示条数
				location.href = "/book_ManagerSystem/books/findMyBookAll?page=1&size="
						+ pageSize;
			}
