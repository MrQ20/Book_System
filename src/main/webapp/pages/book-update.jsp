...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="/book_ManagerSystem/books/update"
				method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="bookName"
								placeholder="${book.bookName}" value="">
						</div>
						<div class="col-md-2 title">作者</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="author"
								placeholder="${book.author}" value="">
						</div>
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text"  class="form-control pull-right"
									   placeholder="${book.publishTime}" id="datepicker-a3"  name="publishTime" value="" >
							</div>
						</div>
