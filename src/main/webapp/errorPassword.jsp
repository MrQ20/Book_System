...
<!--<script src="/book_ManagerSystem//book_ManagerSystem//book_ManagerSystem/plugins/timepicker/bootstrap-timepicker.min.js"></script>-->
<!-- Bootstrap WYSIHTML5 -->
<!--bootstrap-markdown-->
<!-- CK Editor -->
<!-- InputMask -->
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="/book_ManagerSystem/img/timg.jpg"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-footer">
							...
							<div class="pull-right">
								<a href="/book_ManagerSystem/logout"
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting"><a
						href="/book_ManagerSystem/user/findAll"> <i
							class="fa fa-circle-o"></i> 用户管理
					</a></li>
					<li id="system-setting"><a href="/book_ManagerSystem/role/findAll">
							<i class="fa fa-circle-o"></i> 角色管理
					</a></li>
					<li id="system-setting"><a href="/book_ManagerSystem/permission/findAll">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting"><a
						href="/book_ManagerSystem/pages/product/findAll">
							<i class="fa fa-circle-o"></i> 产品管理
					</a></li>
					<li id="system-setting"><a
						href="/book_ManagerSystem/order/findAll?page=1&pageSize=3">
			...
			<section class="content">
				<div class="error-page">
					...
					<div class="error-content">
						...
						<p>
							注册失败 , 你可以 <a href="/book_ManagerSystem/changePassword.jsp">返回到注册</a>
							重新注册
						</p>
