	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="/book_ManagerSystem/sysLog/findAll">日志管理</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='/book_ManagerSystem/syslog/deleteAll'">
											<i class="fa fa-file-o"></i>一键清除
										</button>
									</div>
								</div>
							</div>
									...
									<c:forEach items="${syslogList}" var="sysLog">
										<tr>
											...
											<td class="text-center">
												<a href="/book_ManagerSystem/syslog/delete?id=${sysLog.id}" class="btn bg-olive btn-xs">删除</a>
											</td>
										</tr>
									</c:forEach>
